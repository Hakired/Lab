...
export const shared: UserConfig<DefaultTheme.Config> = {
  ...
  themeConfig: {
    ...
    footer: {
      message: `<a href="https://github.com/Hakired">The LabHub Team</a> <span class="divider">|</span> <a href="https://github.com/Hakired/Lab/commit/${GIT_COMMIT}">${GIT_COMMIT.slice(
        0,
        7
      )}</a>`,
  ...
  vite: {
    ...
    plugins: [
      ...
      GitChangelog({
        maxGitLogCount: 20,
        repoURL: 'https://github.com/Hakired/Lab'
      }),
